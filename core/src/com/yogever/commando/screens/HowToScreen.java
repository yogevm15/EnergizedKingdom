...
public class HowToScreen extends ScreenAdapter {
    ...
    public HowToScreen(EnergiezdCommando game){
        this.game = game;
    }
    ...
    public void show() {
        ...
        layout = new GlyphLayout(font, "You Won!"); //dont do this every frame! Store it as member
        SP = new ShapeRenderer();
        manuScreen = new ManuScreen(game);
        ap = 0.9f;
        isChanged = true;
        background = new Texture(Gdx.files.internal("HowTo.png"));
    ...
    public void render(float delta) {
        ...
        font.draw(batch, "Back to manu", viewport.getWorldWidth() / 2 - width/2, 150 + height/2);
        font.getData().setScale(3);
